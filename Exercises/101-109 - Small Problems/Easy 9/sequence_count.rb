...
# of elements as the count argument, while the values of each element will
# be multiples of the starting number.
...
def sequence(count, starting_number)
  sequence = []
  return sequence if count == 0

  count.times do |count|
    sequence << starting_number * (count + 1)
  end
